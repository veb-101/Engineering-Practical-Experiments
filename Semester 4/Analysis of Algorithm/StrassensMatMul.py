# credits:
# https://github.com/stanislavkozlovski/Algorithms/tree/master/Coursera/algorithms_stanford/Strassen%20Matrix%20Multiplication/python
...
def strassen(matrix_a, matrix_b):
    ...
    if get_matrix_dimensions(matrix_a) != get_matrix_dimensions(matrix_b):
        raise Exception(
            f'Both matrices are not the same dimension! \nMatrix A:{matrix_a} \nMatrix B:{matrix_b}')
